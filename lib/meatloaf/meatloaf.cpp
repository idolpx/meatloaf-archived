...
Meatloaf theFuji; // global fuji device object
...
//iecVoice iecV;
//iecMIDIMaze iecMIDI;
// iecCassette iecC; // now part of Meatloaf theFuji object
//iecModem *iecR;
//iecCPM iecZ;
...
// Scan for networks
void Meatloaf::_net_scan_networks()
{
...
void Meatloaf::_net_scan_result()
{
...
// Get WiFi Status
void Meatloaf::_net_get_wifi_status()
{
...
// Disk Image Mount
void Meatloaf::_disk_image_mount()
{
...
void Meatloaf::_set_boot_config()
{
...
// Disk Image Unmount
void Meatloaf::_disk_image_umount()
{
...
void Meatloaf::shutdown()
{
    for (int i = 0; i < MAX_DISK_DEVICES; i++)
        _fnDisks[i].disk_dev.unmount();
}

void Meatloaf::_open_directory()
{
...
void Meatloaf::_read_directory_entry()
{
...
void Meatloaf::_get_directory_position()
{
...
void Meatloaf::_set_directory_position()
{
...
void Meatloaf::_close_directory()
{
...
void Meatloaf::_get_adapter_config()
{
...
void Meatloaf::_read_host_slots()
{
...
void Meatloaf::_write_host_slots()
{
...
void Meatloaf::_set_host_prefix()
{
...
void Meatloaf::_get_host_prefix()
{
    uint8_t hostSlot = cmdFrame.aux1;
...
void Meatloaf::_read_device_slots()
{
...
void Meatloaf::_write_device_slots()
{
...
void Meatloaf::_populate_slots_from_config()
{
    for (int i = 0; i < MAX_HOSTS; i++)
    {
...
// Temporary(?) function while we move from old config storage to new
void Meatloaf::_populate_config_from_slots()
{
    for (int i = 0; i < MAX_HOSTS; i++)
    {
...
void Meatloaf::_set_device_filename()
{
...
void Meatloaf::_get_device_filename()
{
    char tmp[MAX_FILENAME_LEN];
...
void Meatloaf::insert_boot_device(uint8_t d)
{
...
void Meatloaf::setup(iecBus *iecbus)
{
...
iecDisk *Meatloaf::bootdisk()
{
    return &_bootDisk;
}

void Meatloaf::_process(void)
{
    // cmdFrame.commanddata = commanddata;
    // cmdFrame.checksum = checksum;

    Debug_println("Meatloaf::iec_process() called");
...
int Meatloaf::get_disk_id(int drive_slot)
{
    return _fnDisks[drive_slot].disk_dev.device_id();
}

std::string Meatloaf::get_host_prefix(int host_slot)
{
